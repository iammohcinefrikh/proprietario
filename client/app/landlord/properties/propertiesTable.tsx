        ...
        <div className="flex flex-col gap-4 md:gap-6">
          ...
          { !units.length ? (
            <div className="flex flex-col justify-center items-center border rounded-lg w-full h-[450px] mt-16 p-4 bg-muted/50 md:p-6">
              <p className="text-sm text-muted-foreground text-center md:text-base">Il semble que vous n'ayez pas encore ajouté de propriétés, essayez d'en ajouter une nouvelle.</p>
            </div>
          ) : (
