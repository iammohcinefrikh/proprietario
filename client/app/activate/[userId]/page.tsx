  ...
  return (
    <main className="flex h-screen items-center justify-center p-6">
      <div className="flex flex-col w-full min-h-screen justify-center items-center sm:w-[350px]">
        ...
        <p className="white text-sm text-muted-foreground mt-2 mb-6 text-center">Le lien d'activation n'est pas valide, veuillez vérifier s'il est valide et réessayer ou demander un nouveau lien d'activation.</p>
      </div>
    </main>
  )
}